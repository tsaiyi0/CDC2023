...
#Some control data I am trying to add
```{r} 
pop_change <- control_data(
...
pop_change |> 
  ...
  geom_bar() +
  labs(title = "Percent readmitted by Gender",
       xlab = "Number readmitted")
...
pop_change |> 
  ...
  labs(title = "Percent readmitted by Race",
       xlab = "Number readmitted") +
  geom_bar()
```
...
pop_change |> 
  ...
  labs(title = "Percent readmitted by Age",
       xlab = "Number readmitted") +
  geom_bar()
```
